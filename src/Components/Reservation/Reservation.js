                ...
                <form onSubmit={handleReserveSit} class="mx-auto grid max-w-screen-lg px-6 pb-20">
                    ...
                    <div className='flex justify-center gap-8 items-center'>
                        ...
                        <div class="relative mt-4 w-56">
                            ...
                            <select 
                            className='atepicker-input block w-full rounded-lg border border-emerald-300 bg-emerald-50 p-2.5 pl-10 text-emerald-800 outline-none ring-opacity-30 placeholder:text-emerald-800 focus:ring focus:ring-emerald-300 sm:text-sm' name='table' id="tableSelection"
                            >{renderTableOptions()}
                            </select>
                        </div>
                    </div>
